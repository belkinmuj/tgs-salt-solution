...
def loadWiderResnet(model_path='/home/adam/TernausNetV2/weights/wide_resnet38_ipabn_lr_256.pth.tar'):
    data = torch.load(model_path)
    data = data["state_dict"]
    model = WiderResNet(structure=[3, 3, 6, 3, 1, 1], classes=1000)
